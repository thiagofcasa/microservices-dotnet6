...
namespace GeekShopping.Web.Controllers
{
    public class CartController : Controller
    {
        ...
        public async Task<IActionResult> Checkout(CartViewModel model)
        {
            ...
            //Se o retorno for uma string (no caso do retorno informando a alteração no preço
            if (response != null && response.GetType() == typeof(string))
            {
                //Armazenar temporariamente a mensage de erro na chave "Error" no objeto TempData
                //para ser exibido em outra pagina.
                TempData["Error"] = response;
                
                // retorna a View de Checkout.
